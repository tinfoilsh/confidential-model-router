...
var (
	...
	updateConfigURL = flag.String("u", getEnvOrDefault("UPDATE_CONFIG_URL", "https://api.tinfoil.sh/api/config/router"), "path to runtime config.yml (env: UPDATE_CONFIG_URL)")
